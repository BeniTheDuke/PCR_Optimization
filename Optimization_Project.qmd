...
All four algorithms were compared using the same budget of 200 steps. Under this constraint, SA required significantly less memory (4.02 KB) and time (~1.2s) than GA (10.90 KB, ~9.5s), suggesting that giving SA a proportionally larger step budget could close the accuracy gap. This is also reflected in Table 1 (Performance comparison table), which summarizes runtime, memory usage, and final cost across all algorithms.
