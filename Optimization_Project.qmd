...
Mutation is performed by rnadomly altering each nucleotide with a probability 1/ $L$ per position, following the standard heuristic proposed by Ochoa (2022), introducing diversity and enabling exploration of the search space.

Mutation is performed by randomly altering nucleotides with probability (Ochoa, 2002) introducing diversity and enabling exploration of the search space.
